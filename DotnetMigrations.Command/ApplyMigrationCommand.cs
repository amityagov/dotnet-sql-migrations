...
namespace DotnetMigrations.Command
{
    ...
    {
        [Option("-p|--provider", "Database type. Supported providers: " + Providers.AllString,
        ...
        /// </summary>
        [Option("-d|--migrationsDirectory", "Path to migrations directories, comma separated",
            CommandOptionType.SingleValue)]
