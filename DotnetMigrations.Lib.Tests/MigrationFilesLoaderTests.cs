...
public class MigrationFilesLoaderTests
{
    ...
    public void Load_one_file_with_valid_name_file_loaded()
    {
        ...
        var files = new TestableIDirectoryContents(new IFileInfo[]
        {
            new TestableFileInfo("2014010101 - create table.sql", "some sql", false)
        });
    ...
    public void Load_one_file_with_invalid_name_throws()
    {
        ...
        var files = new TestableIDirectoryContents(new IFileInfo[]
        {
            new TestableFileInfo("create table.sql", "some sql", false)
        });
